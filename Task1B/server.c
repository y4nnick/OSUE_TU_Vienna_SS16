 ...
 * @date    11. April 2016
 * @brief   Server for mastermind
 * @detail  This server acts as an opponent in mastermind
 */
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    for (round = 1; round <= MAX_TRIES && !quit; ++round) {
        ...
        do{
            s = write(connfd, buffer + bytes_send, WRITE_BYTES - bytes_send);
